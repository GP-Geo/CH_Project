...
from .features.earth_paths import (
    EPSILON,
    MIN_EDGES_FOR_DIRECTION,  # noqa: F401  (re-exported for backward compatibility)
    _build_children_from_parents,
    _compute_direction_vector,
    _detect_cellsize,
    _euclidean_2d,
    _normalize_vector,  # noqa: F401  (re-exported; imported by tests/legacy users)
    _sample_path_coords,
    _trace_full_path,
...
# Geometric feature computation. ``MIN_EDGES_FOR_DIRECTION`` and ``EPSILON`` are
# now owned by ``channel_heads.features.earth_paths`` and imported above; they
...
# =============================================================================
# Earth/TopoToolbox path helpers
# =============================================================================
#
# The path-tracing / coordinate helpers below were extracted into
# ``channel_heads.features.earth_paths`` (the canonical home) and are imported
# at the top of this module. They remain importable from here for backward
# compatibility:
#
#   _euclidean_2d, _normalize_vector, _build_children_from_parents,
#   _trace_path_downstream, _compute_direction_vector, _trace_full_path,
#   _sample_path_coords, _detect_cellsize
