...
Re-exports the Earth patch API from the canonical rasterization package
modules. The 5-class encoding
(BACKGROUND/BRANCH_A/BRANCH_B/OTHER_STREAMS/CONFLUENCE_MARKER) is a **frozen
contract** — Mars patches must match the Earth-trained CNN, so the underlying
