"""Earth 5-class stream patch rasterization.

This module owns the single-patch Earth rasterizer used for CNN inputs. The
implementation preserves the historical ``channel_heads.rasterizer`` behavior:
direct final-grid projection, 5-class uint8 encoding, branch protection, and a
confluence marker that overwrites branch values.
"""
...
from channel_heads.features.earth_paths import _trace_full_path
