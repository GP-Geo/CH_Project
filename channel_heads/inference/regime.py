...
relies on (distinct from the lenient :func:`channel_heads.cnn_features.extract_embeddings`,
which returns a manifest-keyed DataFrame). Module globals in the original
script become explicit parameters (``patch_index_path``, ``project_root``).
"""
