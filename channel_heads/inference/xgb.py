"""Shared XGBoost inference helpers for the Mars prediction scripts.

The Mars inference scripts (tabular 5-feature, combined emb/logit, and the
regime variant) each carried their own near-identical copies of these small
artifact-loading, compatibility-checking, and predict-with-threshold routines.
They are consolidated here so every inference entry point performs the *same*
