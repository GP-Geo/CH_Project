"""Lengthwise asymmetry (ΔL) for channel-head pairs.

This module is the canonical home for the lengthwise-asymmetry feature
(Equation 4 of Goren & Shelef 2024): the normalized along-flow path-length
difference between the two channel heads of a pair that share a first common
...
``from channel_heads.geometric_analysis import LengthwiseAsymmetryAnalyzer``
keep working.
...
from ..units import compute_meters_per_degree
from .earth_paths import _detect_cellsize
