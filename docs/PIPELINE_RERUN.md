...
python scripts/train_cnn_baseline.py -v                 # -> models/cnn_outlet_final.pt
python scripts/train_combined_xgb_phase6b.py            # -> models/xgb_geom_*{only,plus_cnn_emb,plus_cnn_logit}.json
```
...
```
Then optionally re-tune a regime threshold: `python scripts/retune_threshold_regime.py --regime regB`
...
- batch PNGs: `scripts/make_result_figures.py`, `scripts/rendering/render_mars_*`
